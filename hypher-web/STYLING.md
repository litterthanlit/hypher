...
**App UI** (signed-in experience, canvas, dialogs, settings) is styled with **semantic CSS classes** and **CSS variables** in [`src/app/globals.css`](src/app/globals.css). Prefer reusing existing classes and tokens documented in [`docs/design-tokens.md`](../../docs/design-tokens.md).
