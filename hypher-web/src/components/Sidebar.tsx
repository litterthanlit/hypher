      ...
      <nav className="sidebar-nav">
        <div className="section">
          <div className="section-title-row">
            ...
            <button className="dashboard-btn" onClick={() => { closeMobile(); onDashboard(); }} title="Project Dashboard (⌘⇧P)">
        ...
        <div className="section">
          <button className="sidebar-digest-btn" onClick={() => { closeMobile(); onDigest(); }}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" width={14} height={14}>
          ...
          <Link href="/app/settings/api-keys" className="sidebar-digest-btn sidebar-settings-link" onClick={closeMobile}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" width={14} height={14}>
          ...
          <Link href="/app/settings/integrations" className="sidebar-digest-btn sidebar-settings-link" onClick={closeMobile}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" width={14} height={14}>
